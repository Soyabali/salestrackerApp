...
class PostVisitorRepo2 {
  // this is a loginApi call functin
  GeneralFunction generalFunction = GeneralFunction();

  Future postComplaint(
      BuildContext context, String visitorName, int visitorCount, String contactNo, String cameFrom,selectedWhomToMeetValue, selectedWardId2, String iVisitorId, uplodedImage, iUserId,) async {
    // sharedP
...
//Your API call
      var headers = {'token': '840BCEF7-E02B-440D-8BDA-C1F1BF6A1C83', 'Content-Type': 'application/json'};
